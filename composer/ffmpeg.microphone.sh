...
export WEBRELAY_INTERNAL_TCP_PORT=${WEBRELAY_INTERNAL_TCP_PORT:-29779}
...
exec ffmpeg -v verbose -f pulse -fragment_size 2000 -ar 44100 -i auto_null.monitor -f mpegts -correct_ts_overflow 0 -codec:a mp2 -b:a 128k -ac 1 -muxdelay 0.001 "http://${CONTAINER_IP_ADDR}:${WEBRELAY_INTERNAL_TCP_PORT}/audioin"
~                                                                                                                                                                                                           
~                               
